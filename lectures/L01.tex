...
% switches
% force sensors/load cells, light sensor/photovoltaic cell/CCD/IR sensor
% clock crystal, thermometer, voltmeter
% speedometers, accelerometers
% GPS
...
% QNX, Win XP Embedded, MicroC/OS-II, VXWorks, Android, iPhone OS, Win 7 Phone, 
\vspace{5em}
% up to slide 45, event-driven approach to embedded software.
