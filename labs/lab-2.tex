...
\lecture{2 (Detecting Footsteps)}{Winter 2014}{Kirill Morozov}{version 1.1}
...
{\bf Note:} We've deliberately made Lab 2 much less directive than Lab 1. We believe that we've included all of the background information you need. But implementation decisions are up to you.
